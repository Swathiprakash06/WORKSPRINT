...
export const employeeStyles = {
  ...
  dashboard: {
    ...
    statusButtons: 'flex flex-wrap gap-3 items-center w-full sm:w-auto',
  ...
  calendar: {
    ...
    `,
    dayCellContent: 'text-center leading-tight',
    dayCellDate: 'font-semibold mb-0.5',
    dayCellStatus: 'text-[9px] sm:text-[10px] font-medium',
    dayCellTime: 'text-[8px] sm:text-[9px] opacity-75',
