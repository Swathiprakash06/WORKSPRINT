                    ...
                    <tbody>
                      {employeeAttendance.length > 0 ? (
                        employeeAttendance.map(att => (
                          <tr key={att.id}>
                            <td className={employeeStyles.history.td}>{att.date}</td>
                            <td className={employeeStyles.history.td}>{att.checkIn || '-'}</td>
                            <td className={employeeStyles.history.td}>{att.checkOut || '-'}</td>
                    ...
                    <div className="space-y-2">
                      {employeeLeaves.map(leave => (
                        <div key={leave.id} className="p-3 bg-gray-50 rounded-lg">
                          <p className="font-medium text-sm">{leave.date}</p>
                    ...
                    <div className="space-y-2">
                      {employeeLateRecords.map(rec => (
                        <div key={rec.id} className="p-3 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                          ...
                          <p className="text-xs text-gray-600">Checked in at {rec.checkIn}</p>
                        </div>
                      ))}
                    </div>
                  ) : (
